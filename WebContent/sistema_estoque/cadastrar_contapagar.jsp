 ...
 <body>  
	 ...
	 <table border=1 cellspacing=0 cellpadding=0 >
			...
			<%
				...
				con.setCpValorConta(Integer.parseInt(request.getParameter("cp_valorconta")));
				con.setCpDataPagamento(request.getParameter("cp_datapagamento"));
				con.setCpDataVencimento(request.getParameter("cp_datavencimento"));
				con.setNfCodigo(Integer.parseInt(request.getParameter("nf_codigo")));
				con.setCpObservacoes(request.getParameter("cp_observacoes"));
				con.inserirDados();
				...
				if (request.getParameter("cp_codigoField").equals(temp.getString("cp_codigo")))
					response.sendRedirect("http://localhost:8084/sistema_estoque/contapagar.jsp?status=Registro já existente");
