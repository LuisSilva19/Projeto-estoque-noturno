	 ...
	 <body>  
		 ...
		 <%  
		       ...
		       if (testa){           
		          ...
		          response.sendRedirect("http://localhost:8084/sistema_estoque/Compras.jsp?status=Consulta efetuada com sucesso"+
		          ...
		          response.sendRedirect("http://localhost:8084/sistema_estoque/compras.jsp?status=Registro não encontrado");  
		       }  
