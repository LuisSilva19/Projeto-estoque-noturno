 ...
 <table border=1 cellspacing=0 cellpadding=0 >
			...
			<tr>
				<td width=50><strong> Código do Nota </strong></td>
			...
			<%
				try {
				con.setNfCodigo(Integer.parseInt(request.getParameter("nf_codigoField")));
				con.setNfValornf(200/*Float.parseFloat(request.getParameter("nf_valornfField"))*/);
				con.setNfTaxaimpostonf(200/*Float.parseFloat(request.getParameter("nf_taxaimpostonfField"))*/);
				con.setNfValorimposto(200/*Float.parseFloat(request.getParameter("nf_valorimpostoField"))*/);
				con.inserirDados();
				...
				if (request.getParameter("nf_codigoField").equals(temp.getString("nf_codigo")))
					response.sendRedirect("http://localhost:8084/sistema_estoque/notafiscal.jsp?status=Registro já existente");
