...
<body>
	<form name="form1" method="post" action="tipopagto.jsp">
		...
		<jsp:setProperty name="con" property="tpg_qtde"
			value="<%=Integer.parseInt(request.getParameter("tpg_qtdeField"))%>" />
			
		<jsp:setProperty name="con" property="tpg_ativo"
			value="<%=(request.getParameter("tpg_ativoField"))%>" />
			
			
		<p>
			<strong>Tabela tipo pagamento </strong>
		</p>
