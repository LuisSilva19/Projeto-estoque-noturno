			...
			<table width="" border="">
				...
				<tr>
					<td height="" bgcolor="red"><p>
							...
							<input name="pro_codigoField" type="text"
								id="pro_codigoField" size=""
								value="<%=(pro_codigo==null)?"":pro_codigo%>">
						</p>
						<p>
							<strong>descricao :</strong> 
							<input name="pro_descricaoField" type="text"
								id="pro_descricaoField" size=""
								value="<%=(pro_descricao==null)?"":pro_descricao%>">
						</p>
						<p>
							<strong>codigo tipo pagamento:</strong> 
							<input name="tpp_codigoField"
								type="text" id="tpp_codigoField" size=""
								value="<%=(tpp_codigo==null)?"":tpp_codigo%>">
						</p>
						<p>
							<strong>preco de custo:</strong> 
							<input name="pro_precocustoField" type="text"
								id="pro_precocustoField" size=""
								value="<%=(pro_precocusto==null)?"":pro_precocusto%>">
						</p>
						<p>
							<strong>preco de venda:</strong> 
							<input name="pro_precovendaField" type="text"
								id="pro_precovendaField" size=""
								value="<%=(pro_precovenda==null)?"":pro_precovenda%>">
						</p>
						<p>
							<strong>estoque:</strong> 
							<input name="pro_estoqueField" type="text"
								id="pro_estoqueField" size=""
								value="<%=(pro_estoque==null)?"":pro_estoque%>">
						</p>
						<p>
							<strong>pro_embalagem:</strong> 
							<input name="pro_embalagemField" type="text"
								id="pro_embalagemField" size=""
								value="<%=(pro_embalagem==null)?"":pro_embalagem%>">
						</p>
						<p>
							<strong>pro_ipi:</strong> 
							<input name="pro_ipiField" type="text"
								id="pro_ipiField" size=""
